...
from rest_framework_3x import VERSION, exceptions, serializers, status
from rest_framework_3x.compat import (
    INDENT_SEPARATORS, LONG_SEPARATORS, SHORT_SEPARATORS
)
from rest_framework_3x.exceptions import ParseError
from rest_framework_3x.request import is_form_media_type, override_method
from rest_framework_3x.settings import api_settings
from rest_framework_3x.utils import encoders
from rest_framework_3x.utils.breadcrumbs import get_breadcrumbs
from rest_framework_3x.utils.field_mapping import ClassLookupDict
...
class HTMLFormRenderer(BaseRenderer):
    ...
    format = 'form'
    charset = 'utf-8'
    template_pack = 'rest_framework_3x/horizontal/'
...
class BrowsableAPIRenderer(BaseRenderer):
    ...
    media_type = 'text/html'
    format = 'api'
    template = 'rest_framework_3x/api.html'
    charset = 'utf-8'
        ...
        with override_method(view, request, method) as request:
            ...
            return form_renderer.render(
                ...
                dict(
                    ...
                    [('template', 'rest_framework_3x/api_form.html')]
                )
            )
...
class AdminRenderer(BrowsableAPIRenderer):
    template = 'rest_framework_3x/admin.html'
    format = 'admin'
