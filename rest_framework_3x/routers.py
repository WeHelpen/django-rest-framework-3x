...
from rest_framework_3x import views
from rest_framework_3x.compat import OrderedDict
from rest_framework_3x.response import Response
from rest_framework_3x.reverse import reverse
from rest_framework_3x.urlpatterns import format_suffix_patterns
...
class SimpleRouter(BaseRouter):
    ...
    def get_lookup_regex(self, viewset, lookup_prefix=''):
        ...
        Note that lookup_prefix is not used directly inside REST rest_framework_3x
