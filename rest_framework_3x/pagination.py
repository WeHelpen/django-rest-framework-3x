...
from rest_framework_3x.compat import OrderedDict
from rest_framework_3x.exceptions import NotFound
from rest_framework_3x.response import Response
from rest_framework_3x.settings import api_settings
from rest_framework_3x.utils.urls import remove_query_param, replace_query_param
...
class PageNumberPagination(BasePagination):
    ...
    template = 'rest_framework_3x/pagination/numbers.html'
...
class CursorPagination(BasePagination):
    ...
    ordering = '-created'
    template = 'rest_framework_3x/pagination/previous_and_next.html'
